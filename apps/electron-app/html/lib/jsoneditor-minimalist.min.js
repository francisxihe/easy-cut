  ...
  return (function (e) {
      ...
      ((i.modes = {}),
        ...
        (i.prototype.setMode = function (e) {
          ...
          try {
            ...
            if ("function" == typeof r.onModeChange && e !== s)
              try {
                r.onModeChange(e, s);
              } catch (e) {
                console.error(e);
        ...
        (i.registerMode = function (e) {
          var t, n;
          if (a.isArray(e)) for (t = 0; t < e.length; t++) i.registerMode(e[t]);
          else {
    ...
    function (e, t, n) {
      ...
      ((m.create = function (e, t) {
        ...
        ((this.container = e),
          ...
          this._setOptions(t),
          t.autocomplete && (this.autocomplete = new d(t.autocomplete)),
        ...
        (m.validate = function () {
          ...
          if (e) {
            ...
            if (this.validateSchema) {
              this.validateSchema(e.getValue()) ||
        ...
        (m.startAutoScroll = function (e) {
          var t = this,
            n = this.content,
            i = h.getAbsoluteTop(n),
            o = n.clientHeight,
            r = i + o;
          (e < i + 24 && n.scrollTop > 0
            ? (this.autoScrollStep = (i + 24 - e) / 3)
            : e > r - 24 && o + n.scrollTop < n.scrollHeight
        ...
        (m._createFrame = function () {
          ...
          ((this.frame.onclick = function (t) {
            ...
            h.addEventListener(this.frame, "focus", e, !0),
            h.addEventListener(this.frame, "blur", e, !0),
          ...
          if (this.options && this.options.modes && this.options.modes.length) {
            var l = this;
            this.modeSwitcher = new c(
              this.menu,
              this.options.modes,
              this.options.mode,
              function (e) {
                (l.modeSwitcher.destroy(),
                  l.setMode(e),
                  l.modeSwitcher.focus());
              },
            );
          }
          (this.options.search && (this.searchBox = new r(this, this.menu)),
            this.options.navigationBar &&
              ...
              (this.treePath = new a(this.navBar)),
        ...
        (m._onEvent = function (e) {
          ...
          if (t && t.selected) {
            ...
            "mousedown" === e.type &&
              l.onDragStart(this.multiselection.nodes, e);
          } else
            "mousedown" === e.type &&
              (this.deselect(),
        ...
        (m._updateTreePath = function (e) {
          function t(e) {
            return void 0 !== e.field
              ? e._escapeHTML(e.field)
              : isNaN(e.index)
                ? e.type
                : e.index;
          }
          if (e && e.length) {
            ...
            (e.forEach(function (e) {
              var i = { name: t(e), node: e, children: [] };
              (e.childs &&
                e.childs.length &&
        ...
        (m._onTreePathSectionSelected = function (e) {
          e && e.node && (e.node.expandTo(), e.node.focus());
        }),
        (m._onTreePathMenuItemSelected = function (e, t) {
          if (e && e.children.length) {
            ...
            n &&
              n.node &&
              (this._updateTreePath(n.node.getNodePath()),
              n.node.expandTo(),
              n.node.focus());
          }
        }),
        (m._startDragDistance = function (e) {
        ...
        (m._updateDragDistance = function (e) {
        ...
        (m._onMultiSelectStart = function (e) {
          var t = l.getNodeFromTarget(e.target);
          if (
            "tree" === this.options.mode &&
            void 0 === this.options.onEditable
          ) {
            ((this.multiselection = { start: t || null, end: null, nodes: [] }),
              this._startDragDistance(e));
            var n = this;
            (this.mousemove ||
              (this.mousemove = h.addEventListener(
                window,
                "mousemove",
                function (e) {
                  n._onMultiSelect(e);
              ...
              this.mouseup ||
                (this.mouseup = h.addEventListener(
                  window,
                  "mouseup",
                  function (e) {
        ...
        (m._onMultiSelect = function (e) {
          if ((e.preventDefault(), this._updateDragDistance(e), e.hasMoved)) {
            ...
            if (n && i) {
              if (
                ((this.multiselection.nodes = this._findTopLevelNodes(n, i)),
                this.multiselection.nodes && this.multiselection.nodes.length)
              ) {
                var o = this.multiselection.nodes[0];
                this.multiselection.start === o ||
                this.multiselection.start.isDescendantOf(o)
        ...
        (m._onMultiSelectEnd = function (e) {
        ...
        (m._findTopLevelNodes = function (e, t) {
          for (
          ...
          if (
            ((s && a) ||
              (r.parent
                ? ((s = r), (a = r), (r = r.parent))
                : ((s = r.childs[0]), (a = r.childs[r.childs.length - 1]))),
            r && s && a)
          ) {
        ...
        (m._onKeyDown = function (e) {
          ...
          if (this.searchBox)
            if (i && 70 == t)
              ...
              (r ? this.searchBox.previous(!0) : this.searchBox.next(!0),
                (s = !0));
            }
          if (
            (this.history &&
              (i && !r && 90 == t
                ? (this._onUndo(), (s = !0))
                : i && r && 90 == t && (this._onRedo(), (s = !0))),
            this.options.autocomplete &&
              !s &&
              !(i || n || o || (1 != e.key.length && 8 != t && 46 != t)))
          ) {
            s = !1;
            var c = "";
            (e.target.className.indexOf("jsoneditor-value") >= 0 &&
              (c = "value"),
              e.target.className.indexOf("jsoneditor-field") >= 0 &&
                (c = "field"));
            var d = l.getNodeFromTarget(e.target);
            setTimeout(
              function (e, t) {
                if (t.innerText.length > 0) {
                  var n = this.options.autocomplete.getOptions(
                    t.innerText,
                    e.getPath(),
                    c,
                    e.editor,
                          ...
                          function (e) {
                            null === e
                              ...
                              : e.options
                                ...
                                : this.autocomplete.show(t, 0, e);
                          }.bind(this),
                        )
                      : n.options
                        ? this.autocomplete.show(t, n.startFrom, n.options)
                        : this.autocomplete.show(t, 0, n);
                } else this.autocomplete.hideDropDown();
              }.bind(this, d, e.target),
              50,
            );
          }
          s && (e.preventDefault(), e.stopPropagation());
        }),
        (m._createTable = function () {
          var e = document.createElement("div");
          ((e.className = "jsoneditor-outer"),
            this.options.navigationBar && h.addClassName(e, "has-nav-bar"),
            (this.contentOuter = e),
        ...
        (m.showContextMenu = function (e, t) {
          var n = [],
            i = this;
          (n.push({
            text: u("duplicateText"),
            title: u("duplicateTitle"),
        ...
        (m.getSelection = function () {
          ...
          if (
            ...
            "down" === this.multiselection.direction
              ? ((e.start = t.serialize()), (e.end = n.serialize()))
              : ((e.start = n.serialize()), (e.end = t.serialize()));
          }
          return e;
        }),
        (m.onSelectionChange = function (e) {
          "function" == typeof e &&
            (this._selectionChangedHandler = h.debounce(
              e,
              this.DEBOUNCE_INTERVAL,
            ));
        }),
        (m.setSelection = function (e, t) {
          e &&
            e.dom &&
            e.range &&
            (console.warn(
              "setSelection/getSelection usage for text selection is depracated and should not be used, see documantaion for supported selection options",
            ),
        ...
        (m._getNodeIntsncesByRange = function (e, t) {
          var n, i;
          e &&
            e.path &&
          ...
          var o = [];
          if (n instanceof l)
            if (i instanceof l && i !== n)
              if (n.parent === i.parent) {
                var e, t;
                n.getIndex() < i.getIndex()
                  ? ((e = n), (t = i))
                  : ((e = i), (t = n));
                var r = e;
                o.push(r);
        ...
        (m.getNodesByRange = function (e, t) {
          var n = this._getNodeIntsncesByRange(e, t),
            i = [];
          return (
            n.forEach(function (e) {
        ...
        (e.exports = [
          { mode: "tree", mixin: m, data: "json" },
          { mode: "view", mixin: m, data: "json" },
          { mode: "form", mixin: m, data: "json" },
        ]));
    },
    function (e, t) {
      "use strict";
      ...
      function i(e) {
        ((this.editor = e),
          ...
          (this.actions = {
            ...
            transform: {
              undo: function (e) {
                e.node.setValue(e.oldValue);
              },
              redo: function (e) {
                e.node.setValue(e.newValue);
              },
            },
          }));
      }
    ...
    function (e, t, n) {
      ...
      ((t.parse = function (e) {
        ...
        (t.sanitize = function (e) {
          ...
          function o(n) {
            (r.push('"'), s++);
            for (var o = t(); s < e.length && o !== n; )
              ('"' === o && "\\" !== i()
                ? r.push('\\"')
                : l.hasOwnProperty(o)
                  ? r.push(l[o])
                  : "\\" === o
                    ? (s++, (o = t()), "'" !== o && r.push("\\"), r.push(o))
                    : r.push(o),
                s++,
                (o = t()));
            o === n && (r.push('"'), s++);
      ...
      ((t.addEventListener = function (e, n, i, o) {
        if (e.addEventListener)
          return (
            void 0 === o && (o = !1),
            "mousewheel" === n && t.isFirefox() && (n = "DOMMouseScroll"),
        ...
        (t.parsePath = function e(t) {
          ...
          var o = t.match(/^\.(\w+)/);
          if (o) ((n = o[1]), (i = t.substr(n.length + 1)));
          else {
        ...
        (t.getInputSelection = function (e) {
          ...
          return (
            ...
            "number" == typeof e.selectionEnd
              ? ((a = e.selectionStart), (l = e.selectionEnd))
              : (i = document.selection.createRange()) &&
                ...
                o.compareEndPoints("StartToEnd", s) > -1
                  ? (a = l = r)
                  : ((a = -o.moveStart("character", -r)),
                    (a += n.slice(0, a).split("\n").length - 1),
                    o.compareEndPoints("EndToEnd", s) > -1
                      ? (l = r)
                      : ((l = -o.moveEnd("character", -r)),
                        (l += n.slice(0, l).split("\n").length - 1)))),
            { startIndex: a, endIndex: l, start: t(a), end: t(l) }
          );
        }),
        ...
        "undefined" != typeof Element &&
          (function () {
            ...
            ("undefined" != typeof Element && e(Element.prototype),
              "undefined" != typeof CharacterData && e(CharacterData.prototype),
            ...
            parse: function (e) {
              ...
              for (var p, f, m, g, v, y, b, w, x, _ = {}; ; ) {
                if (
                  ...
                  if (3 == h) {
                    if (1 == p) throw new Error(E || "Parsing halted.");
                    ((c = this.lexer.yyleng),
                      (a = this.lexer.yytext),
                  ...
                  for (;;) {
                    ...
                    if (0 == m) throw new Error(E || "Parsing halted.");
                    (!(function (e) {
      ...
      ((n.prototype.next = function (e) {
        ...
        (n.prototype._onSearch = function (e) {
          ...
          if (n !== this.lastText || e) {
            ...
            var i = this.results[0]
              ? this.results[0].node.MAX_SEARCH_RESULTS
              : 1 / 0;
            if ((this._setActiveResult(0, !1), void 0 !== n)) {
    ...
    function (e, t, n) {
      ...
      function o(e, t) {
          ...
          o.forEach(function (o) {
            if ("separator" == o.type) {
              ...
              if (
                ...
                ((d.className =
                  "jsoneditor-text" +
                  (o.click ? "" : " jsoneditor-right-margin")),
                ...
                if (o.click) {
                  ...
                  ((p.type = "button"),
                    ...
                    (p.innerHTML = '<div class="jsoneditor-expand"></div>'),
                    l.appendChild(p),
                    o.submenuTitle && (p.title = o.submenuTitle),
                    (u = p));
                } else {
                  var f = document.createElement("div");
                  ((f.className = "jsoneditor-expand"),
                    c.appendChild(f),
                    (u = c));
                }
                ...
                c.innerHTML =
                  '<div class="jsoneditor-icon"></div><div class="jsoneditor-text">' +
                  s(o.text) +
                  "</div>";
              t.push(a);
            }
        ...
        var a = document.createElement("div");
        ((a.className = "jsoneditor-contextmenu"),
          (o.menu = a),
          r.appendChild(a));
        var l = document.createElement("ul");
        ((l.className = "jsoneditor-menu"),
          a.appendChild(l),
          (o.list = l),
          (o.items = []));
        var c = document.createElement("button");
      ...
      ((o.prototype._getVisibleButtons = function () {
        ...
        (o.prototype.show = function (e, t) {
          ...
          if (t) {
            ...
            a.bottom + this.maxHeight < c.bottom ||
              (a.top - this.maxHeight > c.top && (n = !1));
          }
          var h = a.left - l.left,
            d = a.top - l.top;
          if (n) {
            var u = e.offsetHeight;
            ((this.dom.menu.style.left = h + "px"),
              (this.dom.menu.style.top = d + u + "px"),
              (this.dom.menu.style.bottom = ""));
          } else
            ((this.dom.menu.style.left = h + "px"),
              (this.dom.menu.style.top = d + "px"),
              (this.dom.menu.style.bottom = "0px"));
          ((this.rootNode = i(e)), s.insertBefore(this.dom.root, s.firstChild));
          var p = this,
            f = this.dom.list;
          ((this.eventListeners.mousedown = r.addEventListener(
            this.rootNode,
            "mousedown",
            function (e) {
              var t = e.target;
              t == f ||
                p._isChildOf(t, f) ||
                (p.hide(), e.stopPropagation(), e.preventDefault());
            },
          )),
            (this.eventListeners.keydown = r.addEventListener(
              this.rootNode,
              "keydown",
              function (e) {
                p._onKeyDown(e);
            ...
            o.visibleMenu && o.visibleMenu.hide(),
            (o.visibleMenu = this));
        }),
        (o.prototype.hide = function () {
          ...
          for (var e in this.eventListeners)
            if (this.eventListeners.hasOwnProperty(e)) {
              ...
              (t && r.removeEventListener(this.rootNode, e, t),
          ...
          if (
            (i &&
              ...
              setTimeout(function () {
                t.expandedItem != i &&
                  ((i.ul.style.display = ""),
                  r.removeClassName(i.ul.parentNode, "jsoneditor-selected"));
              }, 300),
              ...
              : 37 == a
                ...
                : 38 == a
                  ? ((t = this._getVisibleButtons()),
                    (n = t.indexOf(s)),
                    (i = t[n - 1]),
                    i && "jsoneditor-expand" == i.className && (i = t[n - 2]),
                    i || (i = t[t.length - 1]),
                    i && i.focus(),
                    (l = !0))
                  : 39 == a
                    ...
                    : 40 == a &&
                      ...
                      (n = t.indexOf(s)),
                      (o = t[n + 1]),
                      o && "jsoneditor-expand" == o.className && (o = t[n + 2]),
                      o || (o = t[0]),
                      o && (o.focus(), (l = !0)),
                      (l = !0)),
          ...
          ((this.path.innerHTML = ""),
            e &&
              ...
              e.forEach(function (r, s) {
                ...
                if (
                  ((l.className = "jsoneditor-treepath-element"),
                  (l.innerText = r.name),
                  (l.onclick = t.bind(i, r)),
                  i.path.appendChild(l),
                  r.children.length &&
                    ((a = document.createElement("span")),
                    (a.className = "jsoneditor-treepath-seperator"),
                    (a.innerHTML = "&#9658;"),
                    (a.onclick = function () {
                      var t = [];
                    ...
                    i.path.appendChild(a, i.container)),
                  s === e.length - 1)
                ) {
    ...
    function (e, t, n) {
      ...
      function i(e, t) {
        ((this.editor = e),
          ...
          (this._debouncedOnChangeValue = d.debounce(
            this._onChangeValue.bind(this),
            i.prototype.DEBOUNCE_INTERVAL,
          )),
          (this._debouncedOnChangeField = d.debounce(
      ...
      var o = n(11),
        ...
        p = document.body;
      ((i.prototype.DEBOUNCE_INTERVAL = 150),
        (i.prototype.MAX_SEARCH_RESULTS = 999),
        (i.prototype.MAX_VISIBLE_CHILDS = 100),
        (i.prototype.visibleChilds = i.prototype.MAX_VISIBLE_CHILDS),
        ...
        (i.prototype.findNode = function (e) {
          for (var t = d.parsePath(e), n = this; n && t.length > 0; ) {
            var i = t.shift();
            if ("number" == typeof i) {
              if ("array" !== n.type)
                throw new Error(
                  "Cannot get child node at index " + i + ": node is no array",
                );
              n = n.childs[i];
            } else {
              if ("object" !== n.type)
        ...
        (i.prototype.updateError = function () {
          ...
          if (e && this.dom && this.dom.tr) {
            t ||
              ...
              (this.dom.tdError = t),
              this.dom.tdValue.parentNode.appendChild(t));
            var n = document.createElement("div");
            ((n.className = "jsoneditor-popover jsoneditor-right"),
              n.appendChild(document.createTextNode(e.message)));
            var i = document.createElement("button");
            ((i.type = "button"),
              (i.className = "jsoneditor-schema-error"),
              i.appendChild(n),
              (i.onmouseover = i.onfocus =
                function () {
                  for (
                    var e = ["right", "above", "below", "left"], t = 0;
                    t < e.length;
                    t++
                  ) {
                    var i = e[t];
        ...
        (i.prototype.setValue = function (e, t) {
          var n,
            ...
            r,
            s = this.childs;
          if (s) for (; s.length; ) this.removeChild(s[0], !1);
          ...
          if ("array" == this.type) {
            ...
            for (var c in e)
              e.hasOwnProperty(c) &&
                ...
                void 0 === n ||
                  n instanceof Function ||
                  ((o = new i(this.editor, { field: c, value: n })),
                  (r = a < this.MAX_VISIBLE_CHILDS),
                  this.appendChild(o, r, !1)),
                a++);
            ((this.value = ""),
        ...
        (i.prototype.clone = function () {
          ...
          if (
            ...
            (e.visibleChilds = this.visibleChilds),
            this.childs)
          ) {
            var t = [];
        ...
        (i.prototype.showChilds = function () {
          if (this.childs && this.expanded) {
            ...
            if (t) {
              ...
              for (
                var o = Math.min(this.childs.length, this.visibleChilds),
                  i = this._getNextTr(),
                  r = 0;
                r < o;
                r++
                ...
                var s = this.childs[r];
                (s.getDom().parentNode || t.insertBefore(s.getDom(), i),
                  s.showChilds());
              }
        ...
        (i.prototype.hideChilds = function (e) {
          if (this.childs && this.expanded) {
            ...
            (n.parentNode && n.parentNode.removeChild(n),
              (e && !e.resetVisibleChilds) || delete this.visibleChilds);
          }
        }),
        ...
        (i.prototype.moveBefore = function (e, t) {
          if (this._hasChilds()) {
            ...
            if ((e.parent && e.parent.removeChild(e), t instanceof f))
        ...
        (i.prototype.insertBefore = function (e, t) {
          if (this._hasChilds()) {
            if ((this.visibleChilds++, t == this.append))
              (e.setParent(this),
                (e.fieldEditable = "object" == this.type),
                this.childs.push(e));
            else {
        ...
        (i.prototype.search = function (e, t) {
          ...
          if (
            ...
            void 0 !== this.field && t.length <= this.MAX_SEARCH_RESULTS)
          ) {
            ((n = String(this.field).toLowerCase().indexOf(i)),
              -1 !== n &&
                ((this.searchField = !0),
                t.push({ node: this, elem: "field" })),
          ...
          if (this._hasChilds())
            ...
            void 0 !== this.value &&
            t.length <= this.MAX_SEARCH_RESULTS
          ) {
            var o = String(this.value).toLowerCase();
            ((n = o.indexOf(i)),
              -1 !== n &&
                ((this.searchValue = !0),
                t.push({ node: this, elem: "value" })),
              ...
              case "expand":
                this._hasChilds()
                  ...
                  : t.field && this.fieldEditable
                    ? (t.field.focus(), d.selectContentEditable(t.field))
                    : t.value && !this._hasChilds()
                      ? (t.value.focus(), d.selectContentEditable(t.value))
                      : t.menu.focus();
                break;
              case "field":
                t.field && this.fieldEditable
        ...
        (i.prototype.changeType = function (e) {
          ...
          if (t != e) {
            if (
              ...
              n = this.expanded ? this.getAppendDom() : this.getDom();
        ...
        (i.prototype._getDomValue = function (e) {
          if (
            (this.dom.value &&
              "array" != this.type &&
              "object" != this.type &&
              (this.valueInnerText = d.getInnerText(this.dom.value)),
        ...
        (i.prototype._onChangeValue = function () {
          ...
          if (e.range) {
            var t = d.textDiff(String(this.value), String(this.previousValue));
            ((e.range.startOffset = t.start), (e.range.endOffset = t.end));
          }
          var n = this.editor.getDomSelection();
          if (n.range) {
            var i = d.textDiff(String(this.previousValue), String(this.value));
        ...
        (i.prototype._updateDomValue = function () {
          ...
          if (e) {
            var t = ["jsoneditor-value"],
              n = this.value,
              i = "auto" == this.type ? d.type(n) : this.type,
              o = "string" == i && d.isUrl(n);
        ...
        (i.prototype._updateDomField = function () {
          ...
          if (e) {
            ("" == String(this.field) && "array" != this.parent.type
              ? d.addClassName(e, "jsoneditor-empty")
              : d.removeClassName(e, "jsoneditor-empty"),
              this.searchFieldActive
                ? d.addClassName(e, "jsoneditor-highlight-active")
                : d.removeClassName(e, "jsoneditor-highlight-active"),
              this.searchField
                ? d.addClassName(e, "jsoneditor-highlight")
                : d.removeClassName(e, "jsoneditor-highlight"),
              d.stripFormatting(e));
          }
        }),
        (i.prototype._getDomField = function (e) {
          if (
            (this.dom.field &&
              this.fieldEditable &&
              (this.fieldInnerText = d.getInnerText(this.dom.field)),
              ...
              (e = this.childs
                ...
                .map(function (e) {
                  return {
                    node: e,
                    error: {
                      message: u("duplicateKey") + ' "' + e.field + '"',
                    },
                  };
                }));
          }
        ...
        (i.onDragStart = function (e, t) {
          ...
          if (0 !== e.length) {
            var n = e[0],
              ...
              s = o.nextSibling(),
              a = n.editor,
              l = d.getAbsoluteTop(r.dom.tr) - d.getAbsoluteTop(n.dom.tr);
            (a.mousemove ||
              (a.mousemove = d.addEventListener(
                window,
                "mousemove",
                function (t) {
                  i.onDrag(e, t);
        ...
        (i.onDrag = function (e, t) {
          ...
          if (0 !== e.length) {
            ...
            if (
              ...
              do {
                ((o = o.previousSibling),
                  ...
                  (p = o ? d.getAbsoluteTop(o) : 0));
              } while (o && w < p);
              (c && !c.parent && (c = void 0),
                c ||
                  ((l = n.parentNode.firstChild),
                  (o = l ? l.nextSibling : void 0),
                  (c = i.getNodeFromTarget(o)) == E && (c = void 0)),
                c &&
                  c.isVisible() &&
                  ((o = c.dom.tr),
                  (p = o ? d.getAbsoluteTop(o) : 0),
              ...
              var C = e[e.length - 1];
              if (
                ((a = C.expanded && C.append ? C.append.getDom() : C.dom.tr),
                (s = a ? a.nextSibling : void 0))
              ) {
                ((m = d.getAbsoluteTop(s)), (r = s));
                do {
                  ((h = i.getNodeFromTarget(r)),
                    r &&
                      ((v = r.nextSibling
                        ? d.getAbsoluteTop(r.nextSibling)
                        : 0),
                      (y = r ? v - m : 0),
                      h &&
                        h.parent.childs.length == e.length &&
                        h.parent.childs[e.length - 1] == C &&
                        (u += 27),
                      (r = r.nextSibling)));
                } while (r && w > u + y);
                if (h && h.parent) {
                  ...
                  for (o = h.dom.tr && h.dom.tr.previousSibling; k < N && o; ) {
                    ...
                    if (
                      ...
                      if (!(c instanceof f)) break;
                      var T = c.parent.childs;
                      if (T.length == e.length && T[e.length - 1] == C) break;
                  ...
                  (h instanceof f &&
                    !h.isVisible() &&
                    h.parent.showMore.isVisible() &&
                    (h = h._nextNode()),
                    h &&
                      h.dom.tr &&
                      a.nextSibling != h.dom.tr &&
                      (e.forEach(function (e) {
            ...
            (_ && ((b.drag.mouseX = x), (b.drag.level = E.getLevel())),
              b.startAutoScroll(w),
              t.preventDefault());
          }
        }),
        (i.onDragEnd = function (e, t) {
          ...
          if (0 !== e.length) {
            var n = e[0],
              ...
              a = r.childs[s + e.length] || r.append;
            ...
            (l.oldBeforeNode != l.newBeforeNode && o._onAction("moveNodes", l),
              ...
              delete o.drag,
              o.mousemove &&
                (d.removeEventListener(window, "mousemove", o.mousemove),
                delete o.mousemove),
              o.mouseup &&
                (d.removeEventListener(window, "mouseup", o.mouseup),
                delete o.mouseup),
              o.stopAutoScroll(),
              t.preventDefault());
          }
        ...
        (i.prototype.setHighlight = function (e) {
          this.dom.tr &&
            (e
              ? d.addClassName(this.dom.tr, "jsoneditor-highlight")
              : d.removeClassName(this.dom.tr, "jsoneditor-highlight"),
        ...
        (i.prototype.setSelected = function (e, t) {
          ((this.selected = e),
            this.dom.tr &&
              (e
                ? d.addClassName(this.dom.tr, "jsoneditor-selected")
                : d.removeClassName(this.dom.tr, "jsoneditor-selected"),
              t
                ? d.addClassName(this.dom.tr, "jsoneditor-first")
                : d.removeClassName(this.dom.tr, "jsoneditor-first"),
              this.append && this.append.setSelected(e),
              this.showMore && this.showMore.setSelected(e),
              this.childs &&
                this.childs.forEach(function (t) {
                  t.setSelected(e);
                })));
        ...
        (i.prototype.updateDom = function (e) {
          ...
          if (o) {
            ...
            "array" == this.type
              ? ((o.innerHTML = "[" + r + "]"),
                d.addClassName(this.dom.tr, "jsoneditor-expandable"))
              : "object" == this.type
                ? ((o.innerHTML = "{" + r + "}"),
                  d.addClassName(this.dom.tr, "jsoneditor-expandable"))
                : ((o.innerHTML = this._escapeHTML(this.value)),
                  d.removeClassName(this.dom.tr, "jsoneditor-expandable"));
          }
          (this._updateDomField(),
            this._updateDomValue(),
            e && !0 === e.updateIndexes && this._updateDomIndexes(),
            e &&
              !0 === e.recurse &&
              this.childs &&
              this.childs.forEach(function (t) {
        ...
        (i.prototype._updateSchema = function () {
          this.editor &&
            ...
            ((this.schema = this.editor.options.schema
              ? i._findSchema(this.editor.options.schema, this.getPath())
              : null),
            this.schema
          ...
          for (var s = 0; s < r.length; s++) {
            ...
            for (var a = 0; a < t.length && n; a++) {
              ...
              if (
                ...
                for (var c in n.patternProperties)
                  o = i._findSchema(
                    n.patternProperties[c],
                    t.slice(a, t.length),
                  );
              else
                n.items && n.items.properties
                  ? (n = n.items.properties[l]) &&
                    (o = i._findSchema(n, t.slice(a, t.length)))
                  : "string" == typeof l && n.properties
                    ? (n = n.properties[l] || null) &&
                      (o = i._findSchema(n, t.slice(a, t.length)))
                    : "number" == typeof l &&
                      n.items &&
                      (n = n.items) &&
        ...
        (i.prototype._createDomValue = function () {
          ...
          return (
            "array" == this.type
              ...
              : "object" == this.type
                ? ((e = document.createElement("div")), (e.innerHTML = "{...}"))
                : !this.editable.value && d.isUrl(this.value)
        ...
        (i.prototype.onEvent = function (e) {
          ...
          if (
            ...
            (s.highlight(o),
              s.lock(),
              d.addClassName(i.menu, "jsoneditor-selected"),
              this.showContextMenu(i.menu, function () {
                (d.removeClassName(i.menu, "jsoneditor-selected"),
                  s.unlock(),
                  s.unhighlight());
              }));
          }
          ...
          if (n == l)
            switch (t) {
              ...
              case "change":
                (this._getDomValue(!0),
                  this._updateDomValue(),
                  this.value && (l.innerHTML = this._escapeHTML(this.value)));
                break;
              case "input":
              ...
              case "click":
                e.ctrlKey &&
                  this.editable.value &&
                  d.isUrl(this.value) &&
                  (e.preventDefault(), window.open(this.value, "_blank"));
                break;
              case "keyup":
                (this._getDomValue(!0), this._updateDomValue());
                break;
          ...
          if (n == c)
            switch (t) {
              ...
              case "change":
                (this._getDomField(!0),
                  this._updateDomField(),
                  this.field && (c.innerHTML = this._escapeHTML(this.field)));
                break;
              case "input":
                (this._getDomField(!0),
                  this._updateSchema(),
          ...
          if (h && n == h.parentNode && "click" == t && !e.hasMoved) {
            (void 0 != e.offsetX
              ...
              : e.pageX < d.getAbsoluteLeft(i.tdSeparator)) || r
              ? c && (d.setEndOfContentEditable(c), c.focus())
              : l && !this.enum && (d.setEndOfContentEditable(l), l.focus());
          }
          (((n != i.tdExpand || r) && n != i.tdField && n != i.tdSeparator) ||
            "click" != t ||
            e.hasMoved ||
            (c && (d.setEndOfContentEditable(c), c.focus())),
          ...
          if (13 == h) {
            if (u == this.dom.value)
              (this.editable.value && !e.ctrlKey) ||
                (d.isUrl(this.value) &&
                  (window.open(this.value, "_blank"), (v = !0)));
            else if (u == this.dom.expand) {
              var _ = this._hasChilds();
              if (_) {
                var E = e.ctrlKey;
                (this._onExpand(E), u.focus(), (v = !0));
              }
            }
          } else if (68 == h) p && y && (i.onDuplicate(b), (v = !0));
          else if (69 == h) p && (this._onExpand(m), u.focus(), (v = !0));
          else if (77 == h && y) p && (this.showContextMenu(u), (v = !0));
          else if (46 == h && y) p && (i.onRemove(b), (v = !0));
          else if (45 == h && y)
            p && !m
              ? (this._onInsertBefore(), (v = !0))
              : p && m && (this._onInsertAfter(), (v = !0));
          else if (35 == h) {
            if (g) {
              var C = this._lastNode();
              (C && C.focus(i.focusElement || this._getElementName(u)),
                (v = !0));
            }
          } else if (36 == h) {
            if (g) {
              var S = this._firstNode();
              (S && S.focus(i.focusElement || this._getElementName(u)),
                (v = !0));
            }
          } else if (37 == h) {
            if (g && !m) {
              var j = this._previousElement(u);
              (j && this.focus(this._getElementName(j)), (v = !0));
            } else if (g && m && y) {
              if (x.expanded) {
                var N = x.getAppendDom();
              ...
              o &&
                ...
                (r = o.nextSibling),
                (D = i.getNodeFromTarget(r)),
                n &&
                  n instanceof f &&
                  1 != x.parent.childs.length &&
                  D &&
                  D.parent &&
                  ((s = this.editor.getDomSelection()),
                  (a = x.nextSibling()),
                  b.forEach(function (e) {
                    D.parent.moveBefore(e, D);
                  }),
                  this.focus(i.focusElement || this._getElementName(u)),
            ...
            g && !m
              ? ((t = this._previousNode()),
                t &&
                  ...
                  t.focus(i.focusElement || this._getElementName(u))),
                (v = !0))
              : !g && p && m && y
                ? ((t = this._previousNode()),
                  t &&
                    ((c = this.editor.multiselection),
                    (c.start = c.start || this),
                    (c.end = t),
                    (l = this.editor._findTopLevelNodes(c.start, c.end)),
                    this.editor.select(l),
                    t.focus("field")),
                  (v = !0))
                : g &&
                  m &&
            ...
            if (g && !m) {
              var T = this._nextElement(u);
              (T && this.focus(this._getElementName(T)), (v = !0));
            } else if (g && m && y) {
              k = w.getDom();
            ...
            if (g && !m)
              ((n = this._nextNode()),
                n &&
                  (this.editor.deselect(!0),
                  n.focus(i.focusElement || this._getElementName(u))),
                (v = !0));
            else if (!g && p && m && y)
              ((n = this._nextNode()),
                n &&
              ...
              ((n = x.expanded
                ? x.append
                  ...
                  : void 0
                : x._nextNode()),
                n && !n.isVisible() && (n = n.parent.showMore),
                n && n instanceof f && (n = x));
              var D = n && (n._nextNode() || n.parent.append);
              (D &&
                D.parent &&
                ((s = this.editor.getDomSelection()),
                (a = x.nextSibling()),
        ...
        (i.onRemove = function (e) {
          ...
          if (e && e.length > 0) {
            var t = e[0],
              ...
              r = t.getIndex();
            o.highlighter.unhighlight();
            var s = o.getDomSelection();
            i.blurNodes(e);
            var a = o.getDomSelection();
            (e.forEach(function (e) {
              e.parent._remove(e);
            }),
          ...
          if (this._hasChilds()) {
            ...
            ("object" === this.type
              ? this.childs.sort(function (e, t) {
                  return i * r(e.field, t.field);
                })
              : this.childs.sort(function (t, n) {
                  var o = t.getNestedChild(e),
                    s = n.getNestedChild(e);
                  if (!o) return i;
                  if (!s) return -i;
                  var a = o.value,
                    l = s.value;
        ...
        (i.prototype.findChildByProperty = function (e) {
          if ("object" === this.type)
            return this.childs.find(function (t) {
              return t.field === e;
            });
        }),
        (i.prototype.getPaths = function (e) {
          if ("array" === this.type) {
        ...
        (i.prototype._getPaths = function (e, t, n) {
          (!n ||
            ...
            "object" === this.type
              ? this.childs.forEach(function (i) {
                  "object" === i.type
                    ? i._getPaths(e, t + "." + i.field, n)
                    : ("auto" !== i.type && "string" !== i.type) ||
                      (e[t + "." + i.field] = !0);
                })
              : (e[t || "."] = !0));
        }),
        (i.prototype.getAppendDom = function () {
          return (
            this.append ||
              ((this.append = new f(this.editor)), this.append.setParent(this)),
            this.append.getDom()
          );
        }),
        (i.prototype.getShowMoreDom = function () {
          return (
            this.showMore || (this.showMore = new m(this.editor, this)),
            this.showMore.getDom()
          );
        }),
        ...
        (i.prototype._previousNode = function () {
          ...
          if (t && t.parentNode) {
            ...
            } while (n && e && e instanceof f && !e.isVisible());
          }
          return e;
        }),
        ...
        (i.prototype._lastNode = function () {
          ...
          if (t && t.parentNode) {
            ...
            for (e = i.getNodeFromTarget(n); n && e && !e.isVisible(); )
              ((n = n.previousSibling), (e = i.getNodeFromTarget(n)));
          }
          return e;
        }),
        ...
        (i.prototype.addTemplates = function (e, t) {
          ...
          if (null != i) {
            i.length && e.push({ type: "separator" });
            var o = function (e, t) {
                n._onAppend(e, t);
              },
              r = function (e, t) {
            ...
            i.forEach(function (n) {
              e.push({
                ...
                title: n.title,
                click: t
                  ? o.bind(this, n.field, n.value)
                  : r.bind(this, n.field, n.value),
              });
            });
          }
        }),
        (i.prototype.showContextMenu = function (e, t) {
          ...
          if (
            ...
            this._hasChilds() &&
              (r.push({
                text: u("sort"),
                title: u("sortTitle", { type: this.type }),
                className: "jsoneditor-sort-asc",
                click: function () {
                  var e = n.editor.options.modalAnchor || p;
                  c(n, e);
                },
              }),
              r.push({
                text: u("transform"),
                title: u("transformTitle", { type: this.type }),
            ...
            if (n == a[a.length - 1]) {
              ...
              (n.addTemplates(l, !0),
                r.push({
                  text: u("appendText"),
                  title: u("appendTitle"),
                  submenuTitle: u("appendSubmenuTitle"),
          ...
          new s(r, { close: t }).show(e, this.editor.content);
        }),
        ...
        (i.prototype._stringCast = function (e) {
          ...
          return "" == e
            ...
            : "null" == t
              ? null
              : "true" == t || ("false" != t && (isNaN(n) || isNaN(i) ? e : n));
        }),
    ...
    function (e, t, n) {
      !(function (e) {
        ...
        function t(e) {
          return (
            null !== e && "[object Array]" === Object.prototype.toString.call(e)
          );
        }
        function n(e) {
          return (
        ...
        function i(e, o) {
          ...
          if (!0 === n(e)) {
            ...
            for (var l in o)
              if (hasOwnProperty.call(o, l) && !0 !== s[l]) return !1;
            return !0;
          }
          return !1;
        }
          ...
          ((this._interpreter = e),
            (this.functionTable = {
              ...
              max: {
                ...
                _signature: [{ types: [E, C] }],
              },
              merge: {
                _func: this._functionMerge,
                _signature: [{ types: [x], variadic: !0 }],
              },
              max_by: {
              ...
              keys: { _func: this._functionKeys, _signature: [{ types: [x] }] },
              values: {
        ...
        c.prototype = {
          tokenize: function (e) {
            var t = [];
            this._current = 0;
            for (var n, i, o; this._current < e.length; )
              if (s(e[this._current]))
                ((n = this._current),
                  (i = this._consumeUnquotedIdentifier(e)),
                  t.push({ type: "UnquotedIdentifier", value: i, start: n }));
              else if (void 0 !== S[e[this._current]])
                (t.push({
                  ...
                  this._current++);
              else if (a(e[this._current]))
                ((o = this._consumeNumber(e)), t.push(o));
              else if ("[" === e[this._current])
                ((o = this._consumeLBracket(e)), t.push(o));
              else if ('"' === e[this._current])
                ((n = this._current),
                  (i = this._consumeQuotedIdentifier(e)),
                  t.push({ type: "QuotedIdentifier", value: i, start: n }));
              else if ("'" === e[this._current])
                ((n = this._current),
                  (i = this._consumeRawStringLiteral(e)),
                  t.push({ type: "Literal", value: i, start: n }));
              else if ("`" === e[this._current]) {
                n = this._current;
                var r = this._consumeLiteral(e);
                t.push({ type: "Literal", value: r, start: n });
              } else if (void 0 !== j[e[this._current]])
                t.push(this._consumeOperator(e));
              else if (void 0 !== N[e[this._current]]) this._current++;
              else if ("&" === e[this._current])
                ((n = this._current),
                  this._current++,
                  "&" === e[this._current]
                    ? (this._current++,
                      t.push({ type: "And", value: "&&", start: n }))
                    : t.push({ type: "Expref", value: "&", start: n }));
              else {
                if ("|" !== e[this._current]) {
                ...
                ((n = this._current),
                  ...
                  "|" === e[this._current]
                    ? (this._current++,
                      t.push({ type: "Or", value: "||", start: n }))
                    : t.push({ type: "Pipe", value: "|", start: n }));
              }
            return t;
          },
          _consumeUnquotedIdentifier: function (e) {
            ...
            for (
              this._current++;
              this._current < e.length && l(e[this._current]);
          ...
          _consumeNumber: function (e) {
            var t = this._current;
            this._current++;
            for (var n = e.length; a(e[this._current]) && this._current < n; )
              this._current++;
            return {
              type: "Number",
          ...
          _consumeLiteral: function (e) {
            this._current++;
            for (
              var t, n = this._current, i = e.length;
        ...
        var k = {};
        ((k.EOF = 0),
          (k.UnquotedIdentifier = 0),
          (k.QuotedIdentifier = 0),
          (k.Rbracket = 0),
          (k.Rparen = 0),
          (k.Comma = 0),
          (k.Rbrace = 0),
          ...
          (h.prototype = {
            parse: function (e) {
              ...
              if ("EOF" !== this._lookahead(0)) {
                var n = this._lookaheadToken(0),
                  i = new Error(
                    "Unexpected token type: " + n.type + ", value: " + n.value,
                  );
            ...
            _loadTokens: function (e) {
              var t = new c(),
                n = t.tokenize(e);
              (n.push({ type: "EOF", value: "", start: e.length }),
                (this.tokens = n));
            },
            expression: function (e) {
              var t = this._lookaheadToken(0);
              this._advance();
              for (var n = this.nud(t), i = this._lookahead(0); e < k[i]; )
                (this._advance(),
                  (n = this.led(i, n)),
                  (i = this._lookahead(0)));
              return n;
            ...
            nud: function (e) {
              ...
              switch (e.type) {
                ...
                case "Not":
                  return (
                    (n = this.expression(k.Not)),
                    { type: "NotExpression", children: [n] }
                  );
                case "Star":
                  return (
                    (t = { type: "Identity" }),
                    ...
                    { type: "ValueProjection", children: [t, n] }
                  );
                case "Filter":
                ...
                case "Expref":
                  return (
                    (i = this.expression(k.Expref)),
                    { type: "ExpressionReference", children: [i] }
                  );
                case "Lparen":
                  for (var r = []; "Rparen" !== this._lookahead(0); )
              ...
              switch (e) {
                case "Dot":
                  ...
                  return "Star" !== this._lookahead(0)
                    ? ((n = this._parseDotRHS(i)),
                      { type: "Subexpression", children: [t, n] })
                    : (this._advance(),
                      (n = this._parseProjectionRHS(i)),
                      { type: "ValueProjection", children: [t, n] });
                case "Pipe":
                  return (
                    (n = this.expression(k.Pipe)),
                    { type: "Pipe", children: [t, n] }
                  );
                case "Or":
                  return (
                    (n = this.expression(k.Or)),
                    { type: "OrExpression", children: [t, n] }
                  );
                case "And":
                  return (
                    (n = this.expression(k.And)),
                    { type: "AndExpression", children: [t, n] }
                  );
                case "Lparen":
                  for (
                    var o, r = t.name, s = [];
                    ...
                    ("Current" === this._lookahead(0)
                      ? ((o = { type: "Current" }), this._advance())
                      : (o = this.expression(0)),
                      "Comma" === this._lookahead(0) && this._match("Comma"),
                      s.push(o));
                  return (
                    this._match("Rparen"),
                    { type: "Function", name: r, children: s }
                  );
                case "Filter":
                  ...
                  return (
                    ...
                    { type: "FilterProjection", children: [t, n, a] }
                  );
                case "Flatten":
                  return {
                    type: "Projection",
                ...
                case "Lbracket":
                  ...
                  return "Number" === l.type || "Colon" === l.type
                    ? ((n = this._parseIndexExpression()),
            ...
            _projectIfSlice: function (e, t) {
              var n = { type: "IndexExpression", children: [e, t] };
              return "Slice" === t.type
                ? {
                    type: "Projection",
            ...
            _parseDotRHS: function (e) {
              ...
              return ["UnquotedIdentifier", "QuotedIdentifier", "Star"].indexOf(
                t,
              ) >= 0
                ? this.expression(e)
                : "Lbracket" === t
            ...
            _parseProjectionRHS: function (e) {
              var t;
              if (k[this._lookahead(0)] < 10) t = { type: "Identity" };
            ...
            _parseMultiselectList: function () {
              ...
              return (
                this._match("Rbracket"),
                { type: "MultiSelectList", children: e }
              );
            },
            _parseMultiselectHash: function () {
              for (
                var e,
                  ...
                  i,
                  o = [],
                  r = ["UnquotedIdentifier", "QuotedIdentifier"];
                ;

              ) {
                if (((e = this._lookaheadToken(0)), r.indexOf(e.type) < 0))
                  throw new Error(
                ...
                if (
                  ...
                  this._match("Colon"),
                  (n = this.expression(0)),
                  (i = { type: "KeyValuePair", name: t, value: n }),
                  o.push(i),
                  "Comma" === this._lookahead(0))
                )
                  this._match("Comma");
              ...
              return { type: "MultiSelectHash", children: o };
            },
          }),
          (d.prototype = {
            search: function (e, t) {
              ...
              switch (e.type) {
                case "Field":
                  return null === s
                    ? null
                    : n(s)
                      ? ((u = s[e.name]), void 0 === u ? null : u)
                      : null;
                case "Subexpression":
                  for (
                    c = this.visit(e.children[0], s), m = 1;
                    m < e.children.length;
                    m++
                  )
                    if (null === (c = this.visit(e.children[1], c)))
                      return null;
                  return c;
                case "IndexExpression":
                  return (
                    (p = this.visit(e.children[0], s)),
                ...
                case "Slice":
                  ...
                  var v = e.children.slice(0),
                    ...
                    x = y[2];
                  if (((c = []), x > 0))
                    for (m = b; m < w; m += x) c.push(s[m]);
                  else for (m = b; m > w; m += x) c.push(s[m]);
                  return c;
                case "Projection":
                  var _ = this.visit(e.children[0], s);
                  if (!t(_)) return null;
                  for (f = [], m = 0; m < _.length; m++)
                    null !== (l = this.visit(e.children[1], _[m])) && f.push(l);
                  return f;
                case "ValueProjection":
                  ...
                  for (m = 0; m < E.length; m++)
                    null !== (l = this.visit(e.children[1], E[m])) && f.push(l);
                  return f;
                case "FilterProjection":
                  ...
                  for (m = 0; m < _.length; m++)
                    ((a = this.visit(e.children[2], _[m])),
                      o(a) || C.push(_[m]));
                  for (var j = 0; j < C.length; j++)
                    null !== (l = this.visit(e.children[1], C[j])) && S.push(l);
                  return S;
                case "Comparator":
                  switch (
                    ((h = this.visit(e.children[0], s)),
                    (d = this.visit(e.children[1], s)),
                    e.name)
                  ) {
                    case "EQ":
                      c = i(h, d);
                ...
                case "Flatten":
                  ...
                  for (m = 0; m < N.length; m++)
                    ((l = N[m]), t(l) ? k.push.apply(k, l) : k.push(l));
                  return k;
                case "Identity":
                  return s;
                case "MultiSelectList":
                  if (null === s) return null;
                  for (f = [], m = 0; m < e.children.length; m++)
                    f.push(this.visit(e.children[m], s));
                  return f;
                case "MultiSelectHash":
                  ...
                  for (m = 0; m < e.children.length; m++)
                    ((T = e.children[m]), (f[T.name] = this.visit(T.value, s)));
                  return f;
                case "OrExpression":
                  return (
                    (a = this.visit(e.children[0], s)),
                    o(a) && (a = this.visit(e.children[1], s)),
                    a
                  );
                case "AndExpression":
                  return (
                    (h = this.visit(e.children[0], s)),
                    !0 === o(h) ? h : this.visit(e.children[1], s)
                  );
                case "NotExpression":
                ...
                case "Function":
                  var O = [];
                  for (m = 0; m < e.children.length; m++)
                    O.push(this.visit(e.children[m], s));
                  return this.runtime.callFunction(e.name, O);
                case "ExpressionReference":
                  var D = e.children[0];
                  return ((D.jmespathType = "Expref"), D);
                default:
            ...
            computeSliceParams: function (e, t) {
              ...
              return (
                (n =
                  null === n ? (a ? e - 1 : 0) : this.capSliceRange(e, n, o)),
                (i = null === i ? (a ? -1 : e) : this.capSliceRange(e, i, o)),
                (r[0] = n),
                (r[1] = i),
                (r[2] = o),
                r
          ...
          (u.prototype = {
            callFunction: function (e, t) {
              ...
              return (
                this._validateArgs(e, t, n._signature),
                n._func.call(this, t)
              );
            },
            _validateArgs: function (e, t, n) {
              ...
              if (n[n.length - 1].variadic) {
                if (t.length < n.length)
                  throw (
                    (i = 1 === n.length ? " argument" : " arguments"),
                    new Error(
                      "ArgumentError: " +
                        e +
                        "() takes at least" +
            ...
            _getTypeName: function (e) {
              switch (Object.prototype.toString.call(e)) {
                ...
                case "[object Null]":
                  return 7;
                case "[object Object]":
                  return "Expref" === e.jmespathType ? _ : x;
              }
            },
            ...
            _functionReverse: function (e) {
              if (this._getTypeName(e[0]) === b) {
                for (var t = e[0], n = "", i = t.length - 1; i >= 0; i--)
                  n += t[i];
                return n;
              }
              var o = e[0].slice(0);
            ...
            _functionToString: function (e) {
              return this._getTypeName(e[0]) === b
                ? e[0]
                : JSON.stringify(e[0]);
            },
            ...
            _functionSortBy: function (e) {
              ...
              var n = this._interpreter,
                i = e[1],
                o = this._getTypeName(n.visit(i, t[0]));
              if ([v, b].indexOf(o) < 0) throw new Error("TypeError");
              for (var r = this, s = [], a = 0; a < t.length; a++)
                s.push([a, t[a]]);
              s.sort(function (e, t) {
                var s = n.visit(i, e[1]),
                  a = n.visit(i, t[1]);
                if (r._getTypeName(s) !== o)
                  throw new Error(
                    "TypeError: expected " +
                      o +
                      ", received " +
            ...
            _functionMaxBy: function (e) {
              for (
                var t,
                  ...
                  i = e[1],
                  o = e[0],
                  r = this.createKeyFunction(i, [v, b]),
                  s = -1 / 0,
                  a = 0;
                a < o.length;
                a++
      ...
      e.exports = function e(t, n) {
        ...
        var i,
          ...
          f =
            ...
            (1 !== u.length && h.match(a) && Date.parse(h)),
          m =
            parseInt(d.match(l), 16) ||
            (f && d.match(a) && Date.parse(d)) ||
            null;
        if (m) {
          if (f < m) return -1;
          if (f > m) return 1;
        ...
        for (var g = 0, v = Math.max(u.length, p.length); g < v; g++) {
          if (
            ((i = (!(u[g] || "").match(/^0/) && parseFloat(u[g])) || u[g] || 0),
            (o = (!(p[g] || "").match(/^0/) && parseFloat(p[g])) || p[g] || 0),
            isNaN(i) !== isNaN(o))
          )
            return isNaN(i) ? 1 : -1;
          if ((typeof i != typeof o && ((i += ""), (o += "")), i < o))
            return -1;
          if (i > o) return 1;
        }
        return 0;
      ...
      function i(e) {
        ...
        return (
          ...
          (t.prototype.updateDom = function (e) {
            ...
            var i = t.text;
            i &&
              (i.innerHTML = "(" + s("empty") + " " + this.parent.type + ")");
            var o = t.tr;
            this.isVisible()
              ? t.tr.firstChild ||
                (t.tdDrag && o.appendChild(t.tdDrag),
                t.tdMenu && o.appendChild(t.tdMenu),
                o.appendChild(n))
              : t.tr.firstChild &&
                (t.tdDrag && o.removeChild(t.tdDrag),
                t.tdMenu && o.removeChild(t.tdMenu),
                o.removeChild(n));
          }),
          ...
          (t.prototype.showContextMenu = function (t, n) {
            ...
            new r(l, { close: n }).show(t, this.editor.content);
          }),
          (t.prototype.onEvent = function (e) {
            ...
            if (
              ...
              (r.highlight(this.parent),
                r.lock(),
                o.addClassName(i.menu, "jsoneditor-selected"),
                this.showContextMenu(i.menu, function () {
                  (o.removeClassName(i.menu, "jsoneditor-selected"),
                    r.unlock(),
                    r.unhighlight());
                }));
            }
        ...
        return (
          ...
          (t.prototype.getDom = function () {
            ...
            if ((this._updateEditability(), !this.dom.tr)) {
              ...
              (n.appendChild(document.createTextNode(o("showMore"))),
                (n.href = "#"),
                (n.onclick = function (n) {
                  return (
                    (t.visibleChilds =
                      Math.floor(t.visibleChilds / t.MAX_VISIBLE_CHILDS + 1) *
                      t.MAX_VISIBLE_CHILDS),
                    e.updateDom(),
                    t.showChilds(),
                    n.preventDefault(),
                    !1
              ...
              (i.appendChild(document.createTextNode(o("showAll"))),
                (i.href = "#"),
              ...
              var r = document.createElement("div"),
                s = document.createTextNode(this._getShowMoreText());
              ...
              (l.appendChild(document.createElement("td")),
                l.appendChild(document.createElement("td")),
                l.appendChild(a),
                (l.className = "jsoneditor-show-more"),
                (this.dom.tr = l),
      ...
      function i(e, t) {
        ...
        o({
          ...
          .afterCreate(function (t) {
            ...
            var i = t.modalElem().querySelector("form"),
              o = t.modalElem().querySelector("#ok"),
              r = t.modalElem().querySelector("#field"),
              s = t.modalElem().querySelector("#direction"),
              a = e.getPaths().sort();
            (a.forEach(function (e) {
              var t = document.createElement("option");
              ((t.text = e), (t.value = e), r.appendChild(t));
            }),
              (r.value = e.sortedBy ? e.sortedBy.path : a[0]),
              n(e.sortedBy ? e.sortedBy.direction : "asc"),
              ...
              (o.onclick = function (n) {
                ...
                var i = r.value,
                  o = "." === i ? [] : i.split(".").slice(1);
                ((e.sortedBy = { path: i, direction: s.value }),
                  e.sort(o, s.value));
              }),
      ...
      !(function (n, s) {
        ...
        function e(e) {
          return "object" == typeof Node
            ? e instanceof Node
            : e && "object" == typeof e && "number" == typeof e.nodeType;
        }
        function t(e) {
        ...
        function r(e, t) {
          return o
            ...
            .stylize(e("overlayStyles", { opacity: 0.5, background: "#000" }))
            .onClick(function () {
              e("overlayClose", !0) && t();
            });
        }
          ...
          function o(e) {
            return (
              ...
              (e.hasAttribute("tabindex") ||
                n(e, "input,select,textarea,button,a[href],area[href],iframe"))
            );
          }
          function r(e) {
          ...
          (e.beforeShow(function () {
            ...
            p.watch(function (n) {
              if (t() && e.isVisible()) {
                var i = r(e.modalElem()),
                  o = s(e.modalElem());
                (n.shiftKey ? i : o) === document.activeElement &&
                  ((n.shiftKey ? o : i).focus(), n.preventDefault());
              }
            }));
        }
        function h(e, t) {
          var n,
            i = new o(document.body);
          (e.beforeShow(function () {
            ((n = i.elem.style.overflow),
              t() && i.stylize({ overflow: "hidden" }));
          }),
            e.afterClose(function () {
        ...
        ((o.make = function (e, t) {
          ...
          (o.prototype = {
            ...
            stylize: function (e) {
              ...
              for (var t in e)
                e.hasOwnProperty(t) && (this.elem.style[t] = e[t]);
              return this;
            },
            clazz: function (e) {
            ...
            html: function (t) {
              return (
                e(t) ? this.elem.appendChild(t) : (this.elem.innerHTML = t),
                this
              );
            },
            onClick: function (e) {
        ...
        return (
          ...
          function (i) {
            ...
            function m(e, t) {
              if (!v) {
                var n = s(o, p);
                ((v = { modal: n, overlay: r(o, p), close: a(n, o) }),
                  y.trigger(g, t));
              }
              return v[e];
            }
            ...
            var g,
              ...
              x = n(),
              _ = n(),
              E = m.bind(window, "modal"),
              C = m.bind(window, "overlay"),
              S = m.bind(window, "close");
            return (
              (g = {
                modalElem: l(E),
                closeElem: l(S),
                ...
                isVisible: function () {
                  return !!(v && E && E().isVisible());
                },
                show: function (e) {
                  return (
                    b.trigger(g, e) &&
                      (C().show(), S(), E().show(), w.trigger(g, e)),
                    this
                  );
                },
                close: f(p),
                forceClose: f(d),
                destroy: function () {
                  (E().destroy(), C().destroy(), (C = E = S = void 0));
                },
                options: function (e) {
                ...
                afterShow: f(w.watch),
                beforeClose: f(x.watch),
                afterClose: f(_.watch),
              }),
              c(g, o.bind(null, "focus", !0)),
              h(g, o.bind(null, "bodyOverflow", !0)),
              u.watch(function () {
    ...
    function (e, t, n) {
      function i(e, t) {
        var n = e.getValue(),
          i =
            '<label class="pico-modal-contents jsoneditor-transform-modal"><div class="pico-modal-header">' +
            s("transform") +
            '</div><form><p>Enter a <a href="http://jmespath.org" target="_blank">JMESPath</a> query to filter, sort, or transform the JSON data.<br/>To learn JMESPath, go to <a href="http://jmespath.org/tutorial.html" target="_blank">the interactive tutorial</a>.</p><table><tbody><tr>  <th>' +
            s("transformWizardLabel") +
            ' </th>  <td>  <div id="wizard" class="jsoneditor-jmespath-wizard">  <label>    <div class="jsoneditor-jmespath-wizard-label">' +
            s("transformWizardFilter") +
            '</div>    <div class="jsoneditor-jmespath-filter">      <div class="jsoneditor-select-wrapper">        <select class="jsoneditor-jmespath-filter-field" id="filterField">          <option value="" selected> </option>        </select>      </div>      <div class="jsoneditor-select-wrapper">        <select class="jsoneditor-jmespath-filter-relation" id="filterRelation">          <option value="" selected> </option>          <option value="==">==</option>          <option value="!=">!=</option>          <option value="<">&lt;</option>          <option value="<=">&lt;=</option>          <option value=">">&gt;</option>          <option value=">=">&gt;=</option>        </select>      </div>      <input class="jsoneditor-jmespath-filter-value" id="filterValue" />    </div>  </label>  <label>    <div class="jsoneditor-jmespath-wizard-label">' +
            s("transformWizardSortBy") +
            '</div>    <div class="jsoneditor-jmespath-filter">      <div class="jsoneditor-select-wrapper">        <select class="jsoneditor-jmespath-sort-field" id="sortField">          <option value="" selected> </option>        </select>      </div>      <div class="jsoneditor-select-wrapper">        <select class="jsoneditor-jmespath-sort-order" id="sortOrder">          <option value="" selected> </option>          <option value="asc">Ascending</option>          <option value="desc">Descending</option>        </select>      </div>    </div>  </label>  <label id="selectFieldsPart">    <div class="jsoneditor-jmespath-wizard-label">' +
            s("transformWizardSelectFields") +
            ...
            ' </th>  <td class="jsoneditor-modal-input">    <input id="query" type="text" title="' +
            s("transformQueryTitle") +
            '" value=""/>  </td></tr><tr>  <th>' +
            s("transformPreviewLabel") +
            ' </th>  <td class="jsoneditor-modal-input">    <textarea id="preview"         class="jsoneditor-transform-preview"        readonly> </textarea>  </td></tr><tr><td colspan="2" class="jsoneditor-modal-input jsoneditor-modal-actions">  <input type="submit" id="ok" value="' +
            s("ok") +
            '" /></td></tr></tbody></table></form></div>';
        r({
          parent: t,
          ...
          .afterCreate(function (t) {
            ...
            function r() {
              if (u.value && p.value && f.value) {
                var e = u.value;
                y.value = "[? " + e + " " + p.value + " `" + f.value + "`]";
              } else y.value = "[*]";
              if (m.value && g.value) {
                var t = m.value;
                "desc" === g.value
                  ? (y.value += " | reverse(sort_by(@, &" + t + "))")
                  : (y.value += " | sort_by(@, &" + t + ")");
              }
              if (v.value) {
                for (var n = [], i = 0; i < v.options.length; i++)
                  if (v.options[i].selected) {
                    var o = v.options[i].value;
                    n.push(o);
                  }
                ("]" !== y.value[y.value.length - 1] && (y.value += " | [*]"),
                  1 === n.length
                    ? (y.value += "." + o)
                    : n.length > 1 &&
                      (y.value +=
                        ...
                        n
                          ...
                          .join(", ") +
                        "}"),
                  console.log("selectFields", n));
              }
              s();
            }
            function s() {
              try {
                var e = o.search(n, y.value),
                  t = JSON.stringify(e, null, 2).split("\n");
                (t.length > a && (t = t.slice(0, a).concat(["..."])),
                  (b.className = "jsoneditor-transform-preview"),
                  (b.value = t.join("\n")),
                  (d.disabled = !1));
              } catch (e) {
                ((b.className =
            ...
            var l = t.modalElem(),
              c = l.querySelector("form"),
              h = l.querySelector("#wizard"),
              d = l.querySelector("#ok"),
              u = l.querySelector("#filterField"),
              p = l.querySelector("#filterRelation"),
              f = l.querySelector("#filterValue"),
              m = l.querySelector("#sortField"),
              g = l.querySelector("#sortOrder"),
              v = l.querySelector("#selectFields"),
              y = l.querySelector("#query"),
              b = l.querySelector("#preview");
            (Array.isArray(n) ||
              ((h.style.display = "none"),
              (h.parentNode.style.fontStyle = "italic"),
              ...
              e
                ...
                .forEach(function (e) {
                  ...
                  ((n.text = t), (n.value = t), u.appendChild(n));
                  var o = document.createElement("option");
                  ((o.text = t), (o.value = t), m.appendChild(o));
                }));
            var w = e
              .getPaths(!0)
              .sort()
            ...
            (w.length > 0
              ? w.forEach(function (e) {
                  var t = i(e),
                    n = document.createElement("option");
                  ((n.text = t), (n.value = t), v.appendChild(n));
                })
              : (l.querySelector("#selectFieldsPart").style.display = "none"),
              (y.value = Array.isArray(n) ? "[*]" : "@"),
              (u.onchange = r),
              (p.onchange = r),
              (f.oninput = r),
              (m.oninput = r),
    ...
    function (e, t, n) {
      ...
      function i(e, t, n, i) {
        for (
          ...
          ((c.className =
            "jsoneditor-type-modes" + (n == l ? " jsoneditor-selected" : "")),
            s.push(c));
        }
        var h = r[n];
    ...
    function (e, t) {
      ...
      function n(e) {
        ...
        ((s.className = "autocomplete dropdown"),
        ...
        var a,
          ...
          c = {
            ...
            show: function (e, t, n) {
              ((this.startFrom = t),
                this.wrapper.remove(),
                this.elementHint &&
                  (this.elementHint.remove(), (this.elementHint = null)),
                "" == i &&
                  (i = window
                    .getComputedStyle(e)
              ...
              ((s.style.marginLeft = "0"),
                (s.style.marginTop = e.getBoundingClientRect().height + "px"),
                (this.options = n),
                this.element != e &&
                  ((this.element = e),
                  (this.elementStyle = {
                ...
                this.element.addEventListener &&
                  (this.element.removeEventListener("keydown", d),
                  this.element.addEventListener("keydown", d, !1),
                  this.element.removeEventListener("blur", u),
                  this.element.addEventListener("blur", u, !1)),
                r.appendChild(this.elementHint),
                r.appendChild(s),
            ...
            repaint: function (t) {
              ...
              var o = (this.startFrom, this.options, this.options.length),
                r = i.substring(this.startFrom);
              l = i.substring(0, this.startFrom);
              for (var a = 0; a < o; a++) {
                var c = this.options[a];
                if (
                  (!e.caseSensitive &&
                    0 === c.toLowerCase().indexOf(r.toLowerCase())) ||
                  (e.caseSensitive && 0 === c.indexOf(r))
                ) {
                  ((this.elementHint.innerText = l + r + c.substring(r.length)),
                    (this.elementHint.realInnerText = l + c));
                  break;
                }
              }
              ((s.style.left = n(l) + "px"),
                h.refresh(r, this.options),
                (this.elementHint.style.width =
                  n(this.elementHint.innerText) + 10 + "px"),
                "hidden" == s.style.visibility ||
                  (this.elementHint.style.width =
                    n(this.elementHint.innerText) + s.clientWidth + "px"));
            },
          },
          h = (function (t, n) {
            var i = [],
              ...
              c = {
                ...
                refresh: function (n, r) {
                  ...
                  var h =
                    ...
                    d = t.parentNode.getBoundingClientRect(),
                    u = d.top - 6,
                    p = h - d.bottom - 6;
                  i = [];
                  for (var f = 0; f < r.length; f++)
                    if (
                      !(
                        (e.caseSensitive && 0 !== r[f].indexOf(n)) ||
                        (!e.caseSensitive &&
                          0 !== r[f].toLowerCase().indexOf(n.toLowerCase()))
                      )
                    ) {
                      ...
                      ((m.className = "item"),
                        ...
                        (m.__hint = r[f]),
                        (m.innerHTML =
                          r[f].substring(0, n.length) +
                          "<b>" +
                          r[f].substring(n.length) +
                          "</b>"),
                        i.push(m),
                        t.appendChild(m));
                    }
                  0 !== i.length &&
                    ((1 === i.length &&
                      ((n.toLowerCase() === i[0].__hint.toLowerCase() &&
                        !e.caseSensitive) ||
                        (n === i[0].__hint && e.caseSensitive))) ||
                      i.length < 2 ||
                      (c.highlight(0),
                      u > 3 * p
                        ? ((t.style.maxHeight = u + "px"),
                          (t.style.top = ""),
                          (t.style.bottom = "100%"))
                        : ((t.style.top = "100%"),
                          (t.style.bottom = ""),
                ...
                highlight: function (e) {
                  (-1 != r && i[r] && (i[r].className = "item"),
                    (i[e].className = "item hover"),
                    (r = e));
                },
                move: function (e) {
                  return "hidden" === t.style.visibility
                    ? ""
                    : o + e === -1 || o + e === i.length
                      ? i[o].__hint
                      : ((o += e), c.highlight(o), i[o].__hint);
                },
          ...
          d = function (n) {
            ...
            if (null != this.elementHint && 33 != i && 34 != i) {
              ...
              o = o.replace("\n", "");
              this.startFrom;
              if (e.confirmKeys.indexOf(i) >= 0)
                return (
                  9 == i && 0 == this.elementHint.innerText.length && c.onTab(),
                  void (
                ...
                if (40 == i) {
                  ...
                  return (
                    ...
                    (this.elementHint.innerText =
                      l + r + a.substring(r.length)),
                    (this.elementHint.realInnerText = l + a),
                    n.preventDefault(),
                    void n.stopPropagation()
                  );
                }
        ...
        return (
          (h.onmouseselection = function (e, n) {
            ((n.element.innerText = n.elementHint.innerText = l + e),
              n.hideDropDown(),
    ...
    function (e, t, n) {
      ...
      ((s.create = function (e, t) {
        ...
        if (
          ...
          "ace/theme/jsoneditor" === this.theme && s)
        )
          try {
            n(25);
          } catch (e) {
        ...
        t.onTextSelectionChange &&
          this.onTextSelectionChange(t.onTextSelectionChange);
        var a = this;
        ((this.container = e),
          (this.dom = {}),
          ...
          (this.validateSchema = null),
          (this._debouncedValidate = r.debounce(
            this.validate.bind(this),
            this.DEBOUNCE_INTERVAL,
          )),
        ...
        var d = {},
          u =
            ...
            typeof ("function" === this.options.onEditable) &&
            !this.options.onEditable(d);
        if (
          ((this.content = document.createElement("div")),
          ...
          ((p.$blockScrolling = 1 / 0),
            p.setTheme(this.theme),
            p.setOptions({ readOnly: u }),
            p.setShowPrintMargin(!1),
            p.setFontSize(13),
            p.getSession().setMode("ace/mode/json"),
            p.getSession().setTabSize(this.indentation),
            p.getSession().setUseSoftTabs(!0),
            p.getSession().setUseWrapMode(!0),
            p.commands.bindKey("Ctrl-L", null),
            p.commands.bindKey("Command-L", null),
            (this.aceEditor = p),
          ...
          (f.appendChild(document.createTextNode("powered by ace")),
            ...
            (f.target = "_blank"),
            (f.className = "jsoneditor-poweredBy"),
            (f.onclick = function () {
              window.open(f.href, f.target);
            }),
            this.menu.appendChild(f),
            p.on("change", this._onChange.bind(this)),
            p.on("changeSelection", this._onSelect.bind(this)));
        } else {
          var m = document.createElement("textarea");
          ((m.className = "jsoneditor-text"),
            (m.spellcheck = !1),
            this.content.appendChild(m),
            (this.textarea = m),
            (this.textarea.readOnly = u),
            null === this.textarea.oninput
              ? (this.textarea.oninput = this._onChange.bind(this))
              : (this.textarea.onchange = this._onChange.bind(this)),
            (m.onselect = this._onSelect.bind(this)),
            (m.onmousedown = this._onMouseDown.bind(this)),
            (m.onblur = this._onBlur.bind(this)));
        }
        var g = document.createElement("div");
        if (
          ((g.className = "validation-errors-container"),
          (this.dom.validationErrorsContainer = g),
          this.frame.appendChild(g),
          t.statusBar)
        ) {
          (r.addClassName(this.content, "has-status-bar"),
            (this.curserInfoElements = {}));
          var v = document.createElement("div");
          ((this.dom.statusBar = v),
            (v.className = "jsoneditor-statusbar"),
            this.frame.appendChild(v));
          var y = document.createElement("span");
          ((y.className = "jsoneditor-curserinfo-label"),
            (y.innerText = "Ln:"));
          var b = document.createElement("span");
          ((b.className = "jsoneditor-curserinfo-val"),
            (b.innerText = "1"),
            v.appendChild(y),
            v.appendChild(b));
          var w = document.createElement("span");
          ((w.className = "jsoneditor-curserinfo-label"),
            (w.innerText = "Col:"));
          var x = document.createElement("span");
          ((x.className = "jsoneditor-curserinfo-val"),
            (x.innerText = "1"),
            v.appendChild(w),
            v.appendChild(x),
            (this.curserInfoElements.colVal = x),
            (this.curserInfoElements.lnVal = b));
          var _ = document.createElement("span");
          ((_.className = "jsoneditor-curserinfo-label"),
            (_.innerText = "characters selected"),
            (_.style.display = "none"));
          var E = document.createElement("span");
          ((E.className = "jsoneditor-curserinfo-count"),
            (E.innerText = "0"),
            (E.style.display = "none"),
            (this.curserInfoElements.countLabel = _),
            (this.curserInfoElements.countVal = E),
            v.appendChild(E),
            v.appendChild(_));
        }
        this.setSchema(this.options.schema, this.options.schemaRefs);
        ...
        (s._updateCursorInfo = function () {
          function e() {
            (o.curserInfoElements.countVal.innerText !== i &&
              ((o.curserInfoElements.countVal.innerText = i),
              (o.curserInfoElements.countVal.style.display = i
                ? "inline"
                : "none"),
              (o.curserInfoElements.countLabel.style.display = i
                ? "inline"
                : "none")),
              (o.curserInfoElements.lnVal.innerText = t),
              (o.curserInfoElements.colVal.innerText = n));
          }
          var t,
            n,
            i,
          ...
          if (this.textarea)
            setTimeout(function () {
              var s = r.getInputSelection(o.textarea);
              (s.startIndex !== s.endIndex && (i = s.endIndex - s.startIndex),
                i &&
                o.cursorInfo &&
                o.cursorInfo.line === s.end.row &&
                o.cursorInfo.column === s.end.column
                  ? ((t = s.start.row), (n = s.start.column))
                  : ((t = s.end.row), (n = s.end.column)),
                (o.cursorInfo = { line: t, column: n, count: i }),
                o.options.statusBar && e());
            }, 0);
          else if (this.aceEditor && this.curserInfoElements) {
            var s = this.aceEditor.getCursorPosition(),
              a = this.aceEditor.getSelectedText();
            ((t = s.row + 1),
              (n = s.column + 1),
              (i = a.length),
              (o.cursorInfo = { line: t, column: n, count: i }),
        ...
        (s.setText = function (e) {
          ...
          if (
            ((t =
              !0 === this.options.escapeUnicode ? r.escapeUnicodeChars(e) : e),
        ...
        (s.validate = function () {
          ...
          if (t && this.validateSchema) {
            this.validateSchema(e) ||
              (n = this.validateSchema.errors.map(function (e) {
          ...
          if (n.length > 0) {
            ...
            ((o.innerHTML =
              ...
              n
                ...
                .join("") +
              "</tbody></table>"),
              (this.dom.validationErrors = o),
              this.dom.validationErrorsContainer.appendChild(o));
            var s =
              o.clientHeight +
              (this.dom.statusBar ? this.dom.statusBar.clientHeight : 0);
            ((this.content.style.marginBottom = -s + "px"),
              (this.content.style.paddingBottom = s + "px"));
          }
          if (this.aceEditor) {
            this.aceEditor.resize(!1);
          }
        ...
        (s.getTextSelection = function () {
          var e = {};
          if (this.textarea) {
            var t = r.getInputSelection(this.textarea);
            return (
              this.cursorInfo &&
          ...
          if (this.aceEditor) {
            var n = this.aceEditor.getSelection(),
              ...
              o = n.getRange(),
              s = n.getSelectionLead();
            return (
              s.row === o.end.row && s.column === o.end.column
                ? (e = o)
        ...
        (s.onTextSelectionChange = function (e) {
          "function" == typeof e &&
            (this._selectionChangedHandler = r.debounce(
              e,
              this.DEBOUNCE_INTERVAL,
            ));
        }),
          ...
          if (e && t)
            if (this.textarea) {
              var n = r.getIndexForPosition(this.textarea, e.row, e.column),
                i = r.getIndexForPosition(this.textarea, t.row, t.column);
              if (n > -1 && i > -1)
        ...
        (e.exports = [
          { mode: "text", mixin: s, data: "text", load: s.format },
          { mode: "code", mixin: s, data: "text", load: s.format },
        ]));
    },
    function (e, t, n) {
      var i;
              ...
              function () {
                ((this.getNextLineIndent = function (e, t, n) {
                  ...
                  (this.createWorker = function (e) {
                    var t = new h(["ace"], n(23), "JsonWorker");
                    return (
              ...
              (this.updateCounter = function () {
                ...
                if (t) {
                  var o = this.searchRange
                      ...
                      : e.getValue(),
                    r = e.session.doc.positionToIndex(e.selection.anchor);
                  this.searchRange &&
                    (r -= e.session.doc.positionToIndex(
                      this.searchRange.start,
                    ));
                  for (
                    var s, a = (t.lastIndex = 0);
                    (s = t.exec(o)) &&
                    (n++, (a = s.index), a <= r && i++, !(n > 999)) &&
                    (s[0] || ((t.lastIndex = a += 1), !(a >= o.length)));
